...
export function AppSidebar({
  ...
  return (
    <Sidebar collapsible="icon" {...props}>
      <SidebarHeader>
        <TeamSwitcher
          teams={employee.role.id === 1 ? ownerData.teams : adminData.teams}
        />
      </SidebarHeader>
      <SidebarContent>
        <NavDataMasters
          items={employee.role.id === 1 ? ownerData.masters : adminData.masters}
        />
        <NavOperationals
          operationals={
            employee.role.id === 1
              ? ownerData.operationals
              : adminData.operationals
          }
        />
      </SidebarContent>
      <SidebarFooter>
